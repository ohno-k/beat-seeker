    ...
    <div class="w-full relative min-h-[300px]">
        ...
        <transition name="fade">
            ...
            <p class="text-slate-500 dark:text-slate-400 text-sm mb-4">
                <a href="https://p.eagate.573.jp/game/2dx/33/djdata/score_download.html" target="_blank" rel="noopener noreferrer" class="text-blue-600 dark:text-blue-400 hover:underline font-medium">公式サイト</a>の「スコアデータCSVダウンロード」画面のテキストをコピーして貼り付けてください。
            </p>
