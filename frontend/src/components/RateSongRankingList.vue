      ...
      <table class="w-full">
        <thead>
          <tr class="text-left border-b border-slate-100 dark:border-slate-700/50">
            ...
            <th class="pb-4 text-xs font-black text-emerald-500 uppercase tracking-widest text-right hidden lg:table-cell">{{ t('songRanking.colAvgRatePt') }}</th>
            <th class="pb-4 text-xs font-black" :class="sortMode === 'most' ? 'text-emerald-500' : 'text-orange-500'" style="text-align:right; padding-right:1rem;">{{ t('songRanking.colUserCount') }}</th>
          </tr>
        </thead>
