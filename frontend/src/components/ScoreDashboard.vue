  ...
  <div class="w-full space-y-6 animate-fade-in">
    ...
    <div v-if="showKenbanSaraTier" class="grid grid-cols-1 sm:grid-cols-2 gap-4">
      ...
      <button
        ...
        class="bg-white dark:bg-slate-800 p-4 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 flex flex-col items-center justify-center relative overflow-hidden transition-all duration-200 hover:shadow-md hover:border-cyan-300 dark:hover:border-cyan-600 cursor-pointer text-left w-full">
        <div class="absolute inset-0 bg-gradient-to-br from-cyan-50/40 dark:from-cyan-900/15 to-transparent pointer-events-none"></div>
        <p class="text-[11px] font-medium text-slate-500 dark:text-slate-400 mb-1 z-10 font-bold uppercase tracking-widest">Kenban-Tier <span class="text-cyan-500 dark:text-cyan-400 ml-1">›</span></p>
        <div class="flex flex-col items-center z-10 text-center">
          ...
          <h3 class="text-lg sm:text-xl font-black mb-0.5 line-clamp-1" :class="kenbanRankInfo.color">
        ...
        <p v-if="kenbanNextRankInfo.nextRank" class="text-[9px] font-bold text-slate-400 dark:text-slate-500 mt-1.5 z-10 uppercase tracking-widest text-center">
      ...
      <button
        ...
        class="bg-white dark:bg-slate-800 p-4 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 flex flex-col items-center justify-center relative overflow-hidden transition-all duration-200 hover:shadow-md hover:border-orange-300 dark:hover:border-orange-600 cursor-pointer text-left w-full">
        <div class="absolute inset-0 bg-gradient-to-br from-orange-50/40 dark:from-orange-900/15 to-transparent pointer-events-none"></div>
        <p class="text-[11px] font-medium text-slate-500 dark:text-slate-400 mb-1 z-10 font-bold uppercase tracking-widest">Sara-Tier <span class="text-orange-500 dark:text-orange-400 ml-1">›</span></p>
        <div class="flex flex-col items-center z-10 text-center">
          ...
          <h3 class="text-lg sm:text-xl font-black mb-0.5 line-clamp-1" :class="saraRankInfo.color">
        ...
        <p v-if="saraNextRankInfo.nextRank" class="text-[9px] font-bold text-slate-400 dark:text-slate-500 mt-1.5 z-10 uppercase tracking-widest text-center">
